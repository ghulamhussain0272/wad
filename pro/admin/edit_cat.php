...
if(isset($_POST['update_cat'])){
    ...
    $update_categorie = "update categories set cat_title = '$cat_title'
                                         where cat_id='$cat_id'";

    $update_cat = mysqli_query($con, $update_categorie);
    if($update_cat){
...
<div class="row">
    <div class="offset-md-2 col-md-8">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label class="col-form-label col-sm-4 col-lg-3 d-none d-sm-block" for="pro_title">Categorie Title</label>
